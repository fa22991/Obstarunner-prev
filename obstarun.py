...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self, type):
        ...
        if type == 'fly':
            ...
            fly_1 = pygame.transform.scale(fly1,(100,100))
            fly2 = pygame.image.load('graphics/fly/fly2.png').convert_alpha()
            fly_2 = pygame.transform.scale(fly2, (100, 100))
...
def display_score():
    ...
    score_surf = test_font.render(f'Score: {current_time}', False, (200,200,200))
...
sky_surface = pygame.transform.scale(bg,(800,500))
ground = pygame.image.load('graphics/ground.jpg').convert()
ground_surface = pygame.transform.scale(ground,(800,100))
    ...
    for event in pygame.event.get():
        ...
        if game_active:
            if event.type == obstacle_timer:
                obstacle_group.add(Obstacle(choice(['fly', 'snake', 'snake', 'snake'])))
